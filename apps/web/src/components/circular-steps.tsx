...
// for the dark theme (vectors render white on the #001a23 mark).
function BrandMark() {
  return (
    <svg
      ...
      <div className="circular-steps__stage">
        <header className="circular-steps__header">
          <ScrollFadeText className="type-section-title text-white">
            {title} <span className="text-[#cddfed]">{titleMuted}</span>
          </ScrollFadeText>
          <p className="circular-steps__intro">{description}</p>
        </header>
